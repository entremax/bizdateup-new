...
const Navbar: React.FC<NavbarProps> = ({ type }) => {
  return (
    <div className='fixed flex px-8 items-center left-0 right-0  h-[4rem] z-[999] bg-white shadow-[0px_1px_0px_0px_#E5E9F2]'>
      <Link href={'/'} className={type === 'normal'?'flex-grow':''}>
        <Image
          className='md:pl-8'
          src={'/logo_full.svg'}
          height={80}
      ...
      <div className={type==='normal'?'flex gap-12 items-center':'w-full flex items-center'}>
        ...
        {type==='normal'?
          ...
          <div className={'hidden md:flex gap-2'}>
            <Link
              href={'/refer-earn'}
              className='p-[0.625rem_1.25rem] cursor-pointer outline outline-primary border-0 text-primary rounded-lg'
            >
