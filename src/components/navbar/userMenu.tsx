...
import {Avatar, Badge,Space, Dropdown, Button, Tooltip} from 'antd';
import {useAppDispatch, useAppSelector} from "@/store/hooks";
import {cn} from "@/lib/utils";
import {MenuProps} from "antd/lib";
import {reset as authReset} from "@/reducers/user/authSlice";
import {reset as investReset} from "@/reducers/user/authSlice";
        ...
        <div
          ...
          {user && user?.membership?.isMember !== "no" ? (
            <>
              ...
              />
              <div
                className={'absolute rounded-full bg-primary text-white font-semibold text-xs -bottom-2 left-[0.2rem] px-2'}>VIP
              </div>
            </>) : null}
        </div>
        <Icons.ArrowDown/>
