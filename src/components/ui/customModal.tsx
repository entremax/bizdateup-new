...
import {
  DefaultCenteredContentStyle, DefaultCenteredCustomProps,
  DefaultCenteredModalStyle,
  InvestContentStyle,
  InvestModalCustomProps,
  InvestModalStyle, RiskDisclosureContentStyle, RiskDisclosureCustomProps,
...
const CustomModal: React.FC<Props> = ({location="defaultCentered",children,openWithButton=false,title,...props}) => {
  ...
  return (
    <>
      {openWithButton ? <Button onClick={handleClose} className="!bg-primary !text-white" type="default" size="large" block>
