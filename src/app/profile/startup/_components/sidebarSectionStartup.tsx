...
const sectionTabs = [
  ...
  },
  {
    ...
    name: 'Deal Terms',
    icon: Icons.TextFile,
    segment: 'deal-terms' as Segments,
  ...
  },
  {
    ...
    name: 'Upload Docs',
    icon: UploadIcon,
    segment: 'upload-docs' as Segments,
...
export default function SectionBarStartup({
  ...
  const routeSegment = useSelectedLayoutSegment() as Segments
