  ...
  return (
    <div className="border_gray shadow rounded-xl px-4 lg:px-7 py-4 lg:py-5 grid grid-cols-12">
      <div className="flex  col-span-full">
        <h4 className="text-xl lg:text-2xl font-bold reset flex-grow">Pitch Deck</h4>
