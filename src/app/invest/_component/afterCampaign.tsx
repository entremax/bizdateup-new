...
const AfterCampaign: React.FC<Props> = ({ startup }) => {
  return (
    <div
      className={
        'bg-neutral-300 grid col-span-full md:col-start-2 md:col-end-12 my-16 md:my-32 rounded-xl p-10 justify-center items-center text-center'
      }
    >
      ...
      <p className="reset text-lemon-dark text-center text-2xl font-bold leading-[3.5rem]">
