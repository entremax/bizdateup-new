...
export default function CompanyIntro({ startup }: { startup: StartupData }) {
  ...
  return (
    <>
      <div className="col-span-full flex flex-col py-4 xl:col-start-2 xl:col-end-12 xl:pt-0">
        {isClosed && (
        ...
        <div className="flex items-center gap-4 py-4">
          ...
          <h3 className="reset py-2 text-2xl font-bold leading-normal text-primary-dark md:text-4xl lg:py-4 lg:leading-[4rem] xl:py-0">
            {capitalizeFirstLetter(
      ...
      <div className="col-span-full flex flex-col justify-center gap-4 md:col-start-8 md:pb-8 md:pl-8 xl:col-end-12 xl:gap-7 xl:px-12">
        <div className="grid grid-cols-2 lg:grid-cols-1 lg:gap-2 xl:gap-7">
