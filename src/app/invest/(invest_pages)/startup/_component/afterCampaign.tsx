...
const AfterCampaign: React.FC<Props> = ({ startup }) => {
  return (
    <div
      className={
        'col-span-full my-16 grid items-center justify-center rounded-xl bg-[#F6F6F6] p-10 text-center md:col-start-2 md:col-end-12'
      }>
      ...
      <p className="reset text-center text-2xl font-bold leading-[3.5rem] text-[#1CB86D]">
      ...
      <p className={'reset text-center font-normal text-[#6E6E73]'}>
