...
import DownloadFiles from '@/components/dashboard/startup/downloadZip'
import CompanyInfo from '@/components/dashboard/startup/companyInfo'
import CompanyTarget from '@/components/dashboard/startup/companyTarget'
import StickyCompanyIntro from '@/components/dashboard/startup/stickyCompanyIntro'
