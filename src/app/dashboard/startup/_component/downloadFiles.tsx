...
const generatePdfBlob = (columnDefinitions: [any] , rowData : [any]) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page} orientation={columnDefinitions.length > 4 ? 'landscape' : 'portrait'}>
...
const Investments = ({ columnDefinitions , rowData }: { columnDefinitions: [any] , rowData:[any]  }) => {
