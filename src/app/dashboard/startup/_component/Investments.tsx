...
const columns: ColumnsType<DataType> = [
  ...
  {
    title: <span className="text-sm font-semibold text-gray-400">Date Of Investment</span>,
    dataIndex: 'createdAt',
    key: 'createdAt',
    render: (text) => (
      <span className="font-semibold">
        {formatCustomDate(text)}
      </span>
    ),
  },
  {
...
export default  function Investments({investData}:{investData:StartupInvestment}) {
  ...
  return (
    <div className={' flex flex-col gap-3 rounded-xl p-4 shadow-sm md:mx-14 md:flex-col lg:mx-32'}>
   ...
   {investData?
    <Download columnDefinitions={columnDefinitions} rowData={rowData} />:null
      ...
      <Table
        ...
        columns={columns}
        dataSource={data.slice((currentPage - 1) * tablePagination.pageSize, currentPage * tablePagination.pageSize)}
        pagination={{
          current: currentPage,
