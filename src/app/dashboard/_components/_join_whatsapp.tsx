...
const JoinWhatsApp = ({className, hidden}: { className?: string, hidden: boolean }) => {
  return <>
    <div
      className={cn('border-gray bg-white md:grid justify-center items-center p-5 py-2 rounded-2xl grid-cols-7' + ' ' + className + (hidden ? " hidden" : ''))}
    ...
    >
      ...
      <div className={'grid md:col-span-5 xl:col-span-4 gap-2 grow justify-center items-center text-center xl:text-left py-4'}>
