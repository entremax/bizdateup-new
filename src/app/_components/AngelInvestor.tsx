    ...
    icon: (
      <svg
        ...
        <g clipPath="url(#clip0_301_16439)">
          <path
            d="M20.2266 11.7768H26.7788L23.5027 7.40869L20.2266 11.7768ZM20.2266 16.145H26.7788L23.5027 20.5131L20.2266 16.145Z"
            fill="#8686F5"
            fillOpacity="0.47"
          />
          <path
            d="M1.66235 0.856445H8.21455V27.0653H1.66235C1.37272 27.0653 1.09496 26.9502 0.890161 26.7454C0.685365 26.5406 0.570312 26.2629 0.570312 25.9732V1.94848C0.570312 1.65885 0.685365 1.38109 0.890161 1.17629C1.09496 0.971498 1.37272 0.856445 1.66235 0.856445Z"
            fill="#8686F5"
          />
          <path
            d="M10.3984 0.856445H16.9506C17.2403 0.856445 17.518 0.971498 17.7228 1.17629C17.9276 1.38109 18.0427 1.65885 18.0427 1.94848V25.9732C18.0427 26.2629 17.9276 26.5406 17.7228 26.7454C17.518 26.9502 17.2403 27.0653 16.9506 27.0653H10.3984V0.856445Z"
            fill="#8686F5"
          />
        </g>
        <defs>
          <clipPath id="clip0_301_16439">
            <rect
              ...
              height="26.2088"
              fill="white"
              transform="translate(0.570312 0.856445)"
            />
          </clipPath>
        </defs>
      </svg>
    ...
    icon: (
      <svg
        ...
        <g id="Group">
          <path
            id="Vector"
            d="M4.33203 0.333496H29.6654L25.6654 8.3335H0.332031L4.33203 0.333496Z"
            fill="#8686F5"
          />
          <path
            id="Vector_2"
            d="M4.33203 11H29.6654L25.6654 19H0.332031L4.33203 11Z"
            fill="#DBDBFC"
          />
          <path
            id="Vector_3"
            d="M4.33203 21.667H29.6654L25.6654 29.667H0.332031L4.33203 21.667Z"
            fill="#8686F5"
          />
        </g>
      </svg>
    ...
    icon: (
      <svg
        ...
        <g id="Group">
          <path
            id="Vector"
            d="M29.6654 7.00016V1.66683C29.6654 1.31321 29.5249 0.974068 29.2748 0.724019C29.0248 0.473971 28.6857 0.333496 28.332 0.333496H1.66536C1.31174 0.333496 0.972603 0.473971 0.722555 0.724019C0.472506 0.974068 0.332031 1.31321 0.332031 1.66683V7.00016H29.6654Z"
            fill="#8686F5"
          />
          <path
            id="Vector_2"
            d="M0.332031 9.66699V28.3337C0.332031 28.6873 0.472506 29.0264 0.722555 29.2765C0.972603 29.5265 1.31174 29.667 1.66536 29.667H8.33203V9.66699H0.332031Z"
            fill="#8686F5"
            fillOpacity="0.47"
          />
          <path
            id="Vector_3"
            d="M11 29.667H28.3333C28.687 29.667 29.0261 29.5265 29.2761 29.2765C29.5262 29.0264 29.6667 28.6873 29.6667 28.3337V9.66699H11V29.667Z"
            fill="#8686F5"
          />
        </g>
      </svg>
...
export default function AngelInvestor() {
  return (
    <div className="flex flex-col items-center bg-[#F9F9FC] px-[20px] pt-[60px] lg:pt-[116px] xl:px-[88px]">
      ...
      <div className={'my-12 mt-8 items-center lg:flex lg:justify-center'}>
        <Button
          href={'/signup'}
          className="w-fit p-4"
