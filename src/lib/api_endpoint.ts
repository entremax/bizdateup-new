...
import { EndpointProps } from '@/types/endpoints'
...
export const addInterest = (
  baseUrlExist: boolean = false,
  params?: EndpointProps,
): string =>
  baseUrlExist ? '/marketing/interest/add' : baseUrl + '/marketing/interest/add'
