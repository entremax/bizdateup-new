...
const JoinWhatsApp = ({className, hidden}: { className?: string, hidden: boolean }) => {
  return <>
    <div
      className={cn('border-gray bg-white md:flex justify-center items-center p-5 rounded-2xl grid-cols-6' + ' ' + className + (hidden ? " hidden" : ''))}
      style={{backgroundColor: 'rgba(36, 37, 82, 0.1)'}}
    >
      <div className={'sm:hidden flex items-center justify-center md:relative md:w-[8rem] md:h-[3rem] pt-2'}>
        <Image
      ...
      <div className={'grid gap-2 grow justify-center items-center text-center'}>
