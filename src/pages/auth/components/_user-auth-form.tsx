...
import {useRouter} from 'next/router'; // Import the correct router
...
export default function UserAuthForm({className, requestType}: UserAuthFormProps) {
  ...
  return (
    <div className={`grid col-6 w-full px-4 ${className}`}>
      ...
      <div className="grid gap-4 mt-4">
        ...
        >
          ...
          <span className="text-black font-semibold !justify-self-stretch">Continue with Google</span>
          <div className="grow"></div>
        </Button>
        <Button
        ...
        >
          ...
          <div className="grow"></div>
          <span className="text-black font-semibold !justify-self-stretch">Continue with Facebook</span>
          <div className="grow"></div>
        </Button>
      </div>
      ...
      {withEmail ? (
        <div className="grid w-full">
          ...
          >
            <div className="grow"></div>
            <span className="text-primary !justify-self-stretch text-white">Send OTP</span>
            <div className="grow"></div>
          </Button>
        </div>
      ) : null}
